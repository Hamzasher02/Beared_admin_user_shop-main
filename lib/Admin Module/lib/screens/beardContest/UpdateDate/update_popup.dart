...
import '../../../Providers/BeardContestProvider/contest_time_update_provider.dart';
import '../../../Utils/app_constant.dart';
import '../../../utils/colors.dart';
String id = "";
void UpdateTimeAlertBox(BuildContext context,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Consumer<UpdateTimeProvider>(
                            builder: (context, updateProvider, child) {
                              return InkWell(
                                onTap: () {
                                  print("time id:::${id.toString()}");

                                  // Check if the text fields are empty
                                  if (startController.text.trim().isEmpty || endController.text.trim().isEmpty) {
                                    AppConstants.flutterToast(message: "Please fill in all the fields.");
                                  } else {
                                    updateProvider.updateDateTime(
                                      id: id.toString(),
